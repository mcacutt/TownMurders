...
public class Escort extends RoleActionBase {

    private final TownMurders plugin;

    public Escort(final TownMurders plugin) {
        this.plugin = plugin;
    }
    ...
    public static void giveBook(Player player) {
        ...
        bookMeta.setTitle(ChatColor.BOLD + "" + ChatColor.GREEN + "Escort");
        ArrayList<String> pages = new ArrayList<>();
        final String nl = "\n";
        pages.add(ChatColor.BOLD + "" + ChatColor.GREEN + "Escort"
                + nl + ChatColor.RESET + "" + ChatColor.BLACK + "--------------------"
                + nl + nl + "You are GOOD"
                + nl + ChatColor.GOLD + "ACTION: "
                + nl + ChatColor.BLACK + "Night: Distract"
                + nl + "your target and"
                + nl + "stop them from"
                + nl + "doing their action"
